...
var Toster = (function () {
    ...
    Toster.prototype.success = function (msg) {
        if (msg != "") {
        }
        else {
            alert('success');
    ...
    Toster.prototype.error = function (log) {
        alert(log);
    };
    return Toster;
}());
exports.Toster = Toster;
...
var Input = (function () {
    ...
    Input.prototype.init = function (item) {
...
exports.__esModule = true;
var $ = __webpack_require__(0);
var FormBuilder_1 = __webpack_require__(10);
var BootstrapInputs_1 = __webpack_require__(8);
var Toaster_1 = __webpack_require__(1);
var StringModule_1 = __webpack_require__(4);
var columnBuilder = (function () {
    function columnBuilder(formConfig) {
        this.config = formConfig;
        this.counter = this.config.makeColumn;
        this.className = "col-md-" + 12 / this.config.makeColumn;
    }
    columnBuilder.prototype.allocate = function (input) {
        var html = "";
    ...
    ;
    columnBuilder.prototype.isAlter = function (datafieldCount) {
        return !(datafieldCount % this.config.makeColumn == 0);
    };
    return columnBuilder;
}());
exports.columnBuilder = columnBuilder;
var BootstrapFormBuilder = (function (_super) {
    __extends(BootstrapFormBuilder, _super);
    function BootstrapFormBuilder(configuration) {
        ...
        _this["default"] = {
            ...
            reflectedFields: [],
            model: '',
            toaster: new Toaster_1.Toster()
        };
        _this.inputWrapper = new BootstrapInputWrapper();
        _this.columnBuilder = new columnBuilder(_this.config);
        _this.inputBuilder = new BootstrapInputs_1.bs.BootStrapInputBuilder();
        return _this;
        //this.config = $.extend(this.default, configuration);
    }
    BootstrapFormBuilder.prototype.validationBuilder = function (formName, rules) {
        var self = this;
    ...
    BootstrapFormBuilder.prototype.vertical = function () {
        var i = 1;
        var formfields = "";
    ...
    BootstrapFormBuilder.prototype.horizontal = function () {
        var i = 1;
        var formfields = "";
        //console.log(this.forms.grid);
        var ffields = this.config.reflectedFields;
...
}(FormBuilder_1.FormBuilder));
exports.BootstrapFormBuilder = BootstrapFormBuilder;
var BootstrapInputWrapper = (function () {
    function BootstrapInputWrapper() {
    }
    BootstrapInputWrapper.prototype.inputWrapperHorizontal = function (label, content) {
        //var lblWrapper = sf.String.Format("<div class='control-label col-md-3' >{0}</div>", label);
        var lblWrapper = label;
        var inputWraper = StringModule_1.sf.String.Format("<div class='col-md-9' >{0}</div>", content);
        return lblWrapper + inputWraper;
    };
    BootstrapInputWrapper.prototype.rowWrapper = function (isVertical) {
        throw new Error('Method not implemented.');
    };
    BootstrapInputWrapper.prototype.columnWrapper = function (isVertical) {
        throw new Error('Method not implemented.');
    };
    BootstrapInputWrapper.prototype.labelWrapper = function (isVertical) {
        throw new Error('Method not implemented.');
    };
    BootstrapInputWrapper.prototype.buttonWrapper = function (isVertical, buttons) {
        if (isVertical) {
            return StringModule_1.sf.String.Format("<div class='row clearfix'><div class='pull-right'>{0}</div></div>", buttons);
        }
        else {
            return StringModule_1.sf.String.Format("<div class='row clearfix'><div class='pull-right'>{0}</div></div>", buttons);
        }
    };
    BootstrapInputWrapper.prototype.inputWrapper = function (isVertical, content) {
        if (isVertical) {
            return StringModule_1.sf.String.Format("<div class='form-group '>{0}</div>", content);
        }
        else {
            return StringModule_1.sf.String.Format("<div class='form-group row'>{0}</div>", content);
        }
    };
    return BootstrapInputWrapper;
}());
exports.BootstrapInputWrapper = BootstrapInputWrapper;
...
exports.__esModule = true;
var $ = __webpack_require__(0);
var Reflector_1 = __webpack_require__(3);
var Toaster_1 = __webpack_require__(1);
var FormFiller_1 = __webpack_require__(12);
var OctaGrid = (function () {
    function OctaGrid(options) {
        this["default"] = {
            enableForm: false,
        ...
        this._rowData = [];
        this._rowTotal = 0;
        this.initPagination = function (cp) {
        ...
        var r = new Reflector_1.reflector(this.config.metadata);
        this.reflectedFields = r.getProperties();
    }
    OctaGrid.prototype.ajaxCall = function (url, param, successFx, error) {
        // $.ajax({
        //     type: "POST",
    ...
    OctaGrid.prototype.registerEvents = function () {
    ...
    OctaGrid.prototype.generateActionBar = function () {
        var actionBar = {
    ...
    ;
    OctaGrid.prototype.renderSearchBar = function () {
    ...
    ;
    OctaGrid.prototype.refresh = function () {
        var limit = this.config.containers.itemperpage.val();
        this._currentpage = 1;
    ...
    ;
    OctaGrid.prototype.reload = function (offset, limit, search, filterby) {
    ...
    ;
    OctaGrid.prototype.renderData = function () {
    ...
    ;
    OctaGrid.prototype.renderGrid = function (el) {
        // var data = [];
    ...
    ;
    OctaGrid.prototype.renderCommands = function () {
        var commands = "";
        //edit
        commands += "<td >";
    ...
    ;
    OctaGrid.prototype.renderHeader = function () {
        var header = [];
    ...
    ;
    OctaGrid.prototype.renderRows = function () {
    ...
    ;
    OctaGrid.prototype.renderRow = function (data) {
        var row = data;
    ...
    ;
    OctaGrid.prototype.renderColumns = function (row) {
        var tds = "";
        for (var i = 0; i < this.displayFields.length; i++) {
    ...
    ;
    OctaGrid.prototype.renderHeaderColumn = function (columndef) {
        var td = "";
    ...
    ;
    OctaGrid.prototype.renderColumn = function (columndef, value) {
        var td = "";
        var coltype = columndef.metadata.grid_header_type == undefined ? "text" : columndef.metadata.grid_header_type;
        switch (coltype) {
            case "text":
    ...
    ;
    OctaGrid.prototype.save = function () {
    ...
    ;
    OctaGrid.prototype.findPrimaryKey = function () {
        var primaryKey;
    ...
    ;
    OctaGrid.prototype.onDelete = function (atag) {
    ...
    ;
    OctaGrid.prototype.actionbarDelete = function (ids) {
        //console.log($(atag).parents("tr:eq(0)").data())
        var cg = this;
        if (confirm("Are you sure?")) {
    ...
    ;
    OctaGrid.prototype.deleteSelected = function () {
    };
    ;
    OctaGrid.prototype.createFormDataReady = function (detail) {
        var data = {};
    ...
    ;
    OctaGrid.prototype.onEdit = function (atag) {
        if (this.config.events.onedit == null) {
            ...
            var formdata = new FormFiller_1.FormFiller();
    ...
    ;
    OctaGrid.prototype.search = function () {
    ...
    ;
    OctaGrid.prototype.setForm = function (form) {
        this.config.formBuilder = form;
    };
    ;
    return OctaGrid;
}());
exports.OctaGrid = OctaGrid;
...
(function (bs) {
    var Text = (function (_super) {
        ...
        function Text(options) {
            ...
            _this.config = $.extend(_this.defaults, options);
            _this.elem = $("<input name='" + _this.config.name + "' value='" + _this.config.value + "' type='text' class='" + _this.config["class"] + "' placeholder='" + _this.config.placeholder + "' />");
            _this.name = _this.config.name;
            return _this;
        }
        Text.prototype.init = function (item) {
            console.log('init');
            _super.prototype.init.call(this, item);
        };
    ...
    var Number = (function (_super) {
        ...
        function Number(options) {
            ...
            _this.config = $.extend(_this.defaults, options);
            _this.elem = $("<input name='" + _this.config.name + "' value='" + _this.config.value + "' type='number' class='" + _this.config["class"] + "' placeholder='" + _this.config.placeholder + "' />");
            _this.name = _this.config.name;
            return _this;
        }
        return Number;
    ...
    var Image = (function (_super) {
        ...
        Image.prototype.init = function (item) {
            console.log('init');
            _super.prototype.init.call(this, item);
        };
        ...
        Image.prototype.set = function (value) {
            console.log('set');
            this.elem.val(value);
        };
        return Image;
    ...
    var Select = (function (_super) {
        ...
        function Select(options) {
            ...
            _this.config = $.extend(_this.defaults, options);
            _this.elem = $("<select name='" + _this.config.name + " class='" + _this.config["class"] + "' placeholder='" + _this.config.placeholder + "' />");
            _this.name = _this.config.name;
            return _this;
        }
        Select.prototype.init = function (item) {
    ...
    var TextArea = (function (_super) {
        ...
        function TextArea(options) {
            ...
            _this.config = $.extend(_this.defaults, options);
            _this.elem = $("<textarea name='" + _this.config.name + "'  class='" + _this.config["class"] + "' >" + _this.config.value + "</textarea>");
            _this.name = _this.config.name;
            return _this;
        }
        TextArea.prototype.init = function (item) {
            _super.prototype.init.call(this, item);
        };
    ...
    var Hidden = (function (_super) {
        ...
        function Hidden(options) {
            ...
            _this.config = $.extend(_this.defaults, options);
            _this.elem = $("<input name='" + _this.config.name + "' value='" + _this.config.value + "' type='hidden'   class='" + _this.config["class"] + "' placeholder='" + _this.config.placeholder + "' />");
            _this.name = _this.config.name;
            return _this;
        }
        Hidden.prototype.init = function (item) {
            console.log('init');
            _super.prototype.init.call(this, item);
        };
        Hidden.prototype.clear = function () {
            console.log('clearing');
            this.elem.val('');
        };
        Hidden.prototype.get = function () {
            console.log('getting');
            return { name: this.name, value: this.elem.val() };
            // return this.elem.val();
        };
        Hidden.prototype.set = function (value) {
            console.log('set');
            this.elem.val(value);
        };
        return Hidden;
    ...
    var Button = (function (_super) {
        ...
        function Button(options) {
            ...
            _this.config = $.extend(_this.defaults, options);
            _this.elem = $("<button name='" + _this.config.name + "'  type='button' class='" + _this.config["class"] + "' command='" + _this.config.command + "' >" + _this.config.value + "</button>");
            _this.name = _this.config.name;
            return _this;
        }
        Button.prototype.init = function (item) {
    ...
    var Label = (function (_super) {
        ...
        function Label(options) {
            ...
            _this.config = $.extend(_this.defaults, options);
            _this.elem = $("<label for='" + _this.config.name + "' class='" + _this.config["class"] + "'>" + _this.config.value + "</label>");
            _this.name = _this.config.name;
            return _this;
        }
        return Label;
    ...
    var Checkbox = (function (_super) {
        ...
        function Checkbox(options) {
            ...
            _this.config = $.extend(_this.defaults, options);
            _this.elem = $("<input name='" + _this.config.name + "' value='" + _this.config.value + "' type='checkbox' class='" + _this.config["class"] + "' />");
            _this.name = _this.config.name;
            return _this;
        }
        Checkbox.prototype.init = function (item) {
            _super.prototype.init.call(this, item);
        };
    ...
    var Radio = (function (_super) {
        ...
        function Radio(options) {
            ...
            _this.config = $.extend(_this.defaults, options);
            _this.elem = $("<input name='" + _this.config.name + "' value='" + _this.config.value + "' type='radio' class='" + _this.config["class"] + "' />");
            _this.name = _this.config.name;
            return _this;
        }
        Radio.prototype.init = function (item) {
            _super.prototype.init.call(this, item);
        };
    ...
    var ToggleSwitch = (function (_super) {
        ...
        ToggleSwitch.prototype.init = function (item) {
            console.log('init');
            _super.prototype.init.call(this, item);
        };
        ...
        ToggleSwitch.prototype.get = function () {
            console.log('getting');
            return { name: this.name, value: this.elem.val() };
            // return this.elem.val();
        };
        ToggleSwitch.prototype.set = function (value) {
            console.log('set');
            this.elem.val(value);
        };
        return ToggleSwitch;
    }(Input_1.Input));
    bs.ToggleSwitch = ToggleSwitch;
    var Tags = (function (_super) {
        ...
        Tags.prototype.init = function (item) {
            console.log('init');
            _super.prototype.init.call(this, item);
        };
        ...
        Tags.prototype.set = function (value) {
            console.log('set');
            this.elem.val(value);
        };
        return Tags;
    ...
    var Datepicker = (function (_super) {
        ...
        function Datepicker(options) {
            ...
            _this.config = $.extend(_this.defaults, options);
            _this.elem = $("<input name='" + _this.config.name + "' value='" + _this.config.value + "' type='date' class='" + _this.config["class"] + "' placeholder='" + _this.config.placeholder + "' />");
            _this.name = _this.config.name;
            return _this;
        }
        Datepicker.prototype.init = function (item) {
            console.log('init');
            _super.prototype.init.call(this, item);
        };
    ...
    var BootStrapInputBuilder = (function () {
        function BootStrapInputBuilder() {
        }
        BootStrapInputBuilder.prototype.create = function (type, options) {
            switch (type) {
                case "text":
    ...
    bs.BootStrapInputBuilder = BootStrapInputBuilder;
})(bs = exports.bs || (exports.bs = {}));
...
(function (def) {
    ...
    var Button = (function (_super) {
        ...
        function Button(options) {
            ...
            _this.config = $.extend(_this.defaults, options);
            _this.elem = $("<button name='" + _this.config.name + "'  type='button' class='" + _this.config["class"] + "' >" + _this.config.value + "</button>");
            _this.name = _this.config.name;
            return _this;
        }
        Button.prototype.init = function (item) {
    ...
    var InputBuilder = (function () {
        ...
        InputBuilder.prototype.create = function (type, options) {
            switch (type) {
                case "text":
                    return new Text(options);
                case "number":
...
exports.__esModule = true;
var $ = __webpack_require__(0);
var FormElements_1 = __webpack_require__(11);
var DefaultInputs_1 = __webpack_require__(9);
var Reflector_1 = __webpack_require__(3);
var Toaster_1 = __webpack_require__(1);
var StringModule_1 = __webpack_require__(4);
var FormBuilder = (function () {
    function FormBuilder(configuration) {
        this["default"] = {
            renderAt: null,
            container: $("<div class='col-lg-12'></div>"),
        ...
        this.config = $.extend(this["default"], configuration);
        this.formElements = new FormElements_1.FormElements();
        this.inputBuilder = new DefaultInputs_1.def.InputBuilder();
        var r = new Reflector_1.reflector(this.config.metadata);
        this.config.reflectedFields = r.getProperties();
        console.log(this.config);
    }
    FormBuilder.prototype.ajaxCall = function (url, param, successFx, error) {
        $.ajax({
            type: "POS",
            contentType: "application/json; charset=utf-8",
            async: false,
    ...
    //     }
    // }
    FormBuilder.prototype.vertical = function () {
        throw new Error('Method not implemented.');
    };
    FormBuilder.prototype.horizontal = function () {
        throw new Error('Method not implemented.');
    };
    FormBuilder.prototype.validationBuilder = function (formName, rules) {
        throw new Error('Method not implemented.');
    };
    ...
    FormBuilder.prototype.createForm = function (options) {
        console.log('creating form');
        return StringModule_1.sf.String.Format("<form name='{0}' method={1} action='{2}' class='{4}'>{3}</form>", options.name, options.method, options.action, options.formelements, options.className);
    };
    ...
    FormBuilder.prototype.createVertical = function () {
        this.vertical();
    };
    FormBuilder.prototype.createHorizontal = function () {
        this.horizontal();
    };
    ...
    FormBuilder.prototype.registerEvents = function () {
    ...
    FormBuilder.prototype.setGrid = function (grid) {
...
var FormElements = (function () {
    ...
    FormElements.prototype.Register = function (self) {
        this.elements.push(self);
    };
    FormElements.prototype.Initialize = function (log) {
        this.elements.forEach(function (item) {
            var scope = item || window;
            item.init.call(scope, log);
        });
    };
    FormElements.prototype.Clear = function (log) {
        this.elements.forEach(function (item) {
            var scope = item || window;
            item.clear.call(scope, log);
        });
    };
    FormElements.prototype.GetAll = function (log) {
        var returns = [];
        this.elements.forEach(function (item) {
            var scope = item || window;
    ...
    FormElements.prototype.GetByName = function (name) {
    ...
    FormElements.prototype.SetAll = function () {
    };
    FormElements.prototype.SetByName = function (name, value) {
        var element = this.elements.filter(function (item) {
            if (item.name == name) {
                return item;
            }
...
var FormFiller = (function () {
    ...
    FormFiller.prototype.fill = function (formName, model) {
...
var BootstrapFormBuilder_1 = __webpack_require__(6);
...
var formbuilder = new BootstrapFormBuilder_1.BootstrapFormBuilder({
    renderAt: "#formhere",
    showVertical: false,
    model: 'brand',
    makeColumn: 2,
...
var grid = new Grid_1.OctaGrid(options);
...
/***/ })
/******/ ]);
//# sourceMappingURL=octagrid.min.js.map